...
__global__
void Solve3dLidarKernel(const float *uproj0, const float *vproj0,
	...
	float *X, float *Y, float *Z)
{
	...
	if ((iy < height) && (ix < width))
	{
		...
		float lambetams = lambdams / sqrt((Yx*Zy - Zx * Yy)*(Yx*Zy - Zx * Yy) + 
			(Zx*Xy - Xx * Zy)*(Zx*Xy - Xx * Zy) + (Xx*Yy - Yx * Xy)*(Xx*Yy - Yx * Xy) + 0.001f);
...
__global__
void Solve3dLidarLoopKernel(const float *uproj0, const float *vproj0,
	const float *X0, const float *Y0, const float *Z0,
	const float *Xsp, const float *Ysp, const float *Zsp,
	float P11, float P12, float P13, float P14,
	float P21, float P22, float P23, float P24,
...
void sor::ReconFlow::Solve3dLidar(const float *uproj0, const float *vproj0,
	const float *X0, const float *Y0, const float *Z0,
	const float *Xsp, const float *Ysp, const float *Zsp,
	...
	float *X, float *Y, float *Z)
{
	...
	Solve3dLidarKernel << < blocks, threads >> > (uproj0, vproj0,
		X0, Y0, Z0,
		Xsp, Ysp, Zsp,
...
void sor::ReconFlow::Solve3dLidarLoop(const float *uproj0, const float *vproj0,
	const float *X0, const float *Y0, const float *Z0,
	const float *Xsp, const float *Ysp, const float *Zsp,
	double *P, double *Q, //camera matrices
	float lambdaf, float lambdams, float lambdasp, float *spmask,
	...
	float *X, float *Y, float *Z)
{
	...
	Solve3dLidarLoopKernel << < blocks, threads >> > (uproj0, vproj0,
		X0, Y0, Z0,
		Xsp, Ysp, Zsp,
		P11, P12, P13, P14, P21, P22, P23, P24, P31, P32, P33, P34,
		Q11, Q12, Q13, Q14, Q21, Q22, Q23, Q24, Q31, Q32, Q33, Q34,
